...
> [!IMPORTANT]
> Version 0.3.2 is in development. It reports player activity and locations and
...
Application version `0.3.2` provides:
...
The v0.3.2 milestone is under active validation and is not released. Follow the [roadmap](ROADMAP.md) for planned milestones; roadmap items are directional and not promises of delivery dates.
