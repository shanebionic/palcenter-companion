...
constexpr std::string_view capabilities_without_admin_actions{
    R"({"schemaVersion":"1","categories":{"events":{"supported":false,"capabilityVersion":"1"},"playerActivity":{"supported":true,"capabilityVersion":"1"},"playerLocations":{"supported":true,"capabilityVersion":"1"},"coordinateSpaces":{"supported":true,"capabilityVersion":"1"},"adminActions":{"supported":false,"capabilityVersion":"2","actions":{"teleportAdminToPlayer":false,"teleportPlayerToAdmin":false,"teleportPlayerToLocation":false}},"guilds":{"supported":false,"capabilityVersion":"1"},"bases":{"supported":false,"capabilityVersion":"1"},"performance":{"supported":false,"capabilityVersion":"1"},"moderation":{"supported":false,"capabilityVersion":"1"},"administration":{"supported":false,"capabilityVersion":"1"},"health":{"supported":true,"capabilityVersion":"1"},"version":{"supported":true,"capabilityVersion":"1"}}})"};
